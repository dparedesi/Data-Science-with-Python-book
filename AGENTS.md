...
- **Name:** `render-book`
  - **Trigger:** Render the book into HTML or PDF formats using Quarto. Use when the user wants to "render the book", "build the book", "generate the book", or create HTML/PDF output.
